...
def movie_path(mouse, date, file):
    ...
    return "N:/GEVI_Wave/Analysis/Visual/" + mouse + "/20" + str(date) + "/" + file + '/cG_unmixed_dFF_denoised.h5'
...
def mean_dynamic_spectrum(trial_info_path, title, name, pre_window=2.0, post_window=3.0, **filters):
    """
...
def main(mouse_name, trial_info_file):
   ...
   # Open the HDF5 file (create if it doesn't exist)
    h5_path = f"results/{mouse_name}_dynamic_spec_denoised.h5"
...
main('rfm001', 'trial_info/TrialInfo_rfm001mjr.csv')